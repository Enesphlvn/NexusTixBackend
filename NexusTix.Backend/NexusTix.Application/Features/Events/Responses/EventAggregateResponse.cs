...
public record EventAggregateResponse(int Id, string Name, DateTimeOffset Date, decimal Price, string? Description, int Capacity, EventTypeResponse EventType, VenueWithLocationResponse Venue, IEnumerable<string> ArtistNames);
