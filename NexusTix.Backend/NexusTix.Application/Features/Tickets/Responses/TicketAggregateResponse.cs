...
public record TicketAggregateResponse(int Id, EventResponse Event, UserResponse User, Guid QRCodeGuid, DateTimeOffset PurchaseDate, bool IsUsed, bool IsCancelled);
